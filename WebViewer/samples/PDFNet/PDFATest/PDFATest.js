...
exports.runPDFA = function()
{
	function* main() {
		...
		try{
			...
			var input_url = "../TestFiles/";
			var output_url = "../TestFiles/Output/";
			...
			var pdfa = yield PDFNet.PDFACompliance.createFromUrl(convert, url_input, pwd, PDFNet.PDFACompliance.Conformance.e_Level1B, exceptions, max_ref_objs, first_stop);
			...
			var pdfa_validate = yield PDFNet.PDFACompliance.createFromBuffer(validate_only, doc_buffer, pwd, PDFNet.PDFACompliance.Conformance.e_Level1B, exceptions, max_ref_objs, first_stop);
